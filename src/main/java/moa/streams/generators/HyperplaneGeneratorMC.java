 ...
 * @version $Revision: 7 $
 */
public class HyperplaneGeneratorMC extends AbstractOptionHandler implements
    ...
    public InstanceExample nextInstance() {
        ...
        double ratio = sum / sumWeights;
        double sumRoulette = 0.0;
        
        for (int i = 0; i < this.numClassesOption.getValue(); i++) {
        	sumRoulette += 1.0 / this.numClassesOption.getValue();
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == HyperplaneGeneratorMC.class)
