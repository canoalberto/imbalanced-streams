...
import moa.classifiers.core.attributeclassobservers.GHNumericAttributeClassObserver;
 ...
 * 
 * The GHVFDT utilises a decision tree split criterion designed to improve minority
 ...
 * @version $Revision: 1 $
 */
public class GHVFDT extends AbstractClassifier implements MultiClassClassifier, CapabilitiesHandler
{
	...
	public String getPurposeString() {
		return "Gaussian Hellinger Very Fast Decision Tree or GHVFDT.";
	}
	...
	public static class Node extends AbstractMOAObject 
	{
		...
		public double[] getClassVotes(Instance inst, GHVFDT ht) {
			return this.observedClassDistribution.getArrayCopy();
		}
		...
		public void describeSubtree(GHVFDT ht, StringBuilder out,
				int indent) {
	...
	public static abstract class LearningNode extends Node {
		...
		public abstract void learnFromInstance(Instance inst, GHVFDT ht);
	}
	...
	public static class InactiveLearningNode extends LearningNode {
		...
		@Override
		public void learnFromInstance(Instance inst, GHVFDT ht) {
	...
	public static class ActiveLearningNode extends LearningNode {
		...
		public AttributeSplitSuggestion[] getBestSplitSuggestions(
				SplitCriterion criterion, GHVFDT ht) {
	...
	protected void attemptToSplit(ActiveLearningNode node, SplitNode parent, int parentIndex) 
	{
		...
		{
			// NOTE: Modification made here to convert Hoeffding tree into GHVFDT.
