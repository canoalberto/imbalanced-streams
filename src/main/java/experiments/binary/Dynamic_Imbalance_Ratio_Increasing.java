...
public class Dynamic_Imbalance_Ratio_Increasing {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] generators = new String[] {
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 4 -i 0.05 -g (moa.streams.generators.AgrawalGenerator -i 4 -f 1)) -r 4 "
		  						 + "-d (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 5 -i 0.01 -g (moa.streams.generators.AgrawalGenerator -i 5 -f 1)) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 4 -i 0.05 -g (moa.streams.generators.AssetNegotiationGenerator -i 4 -f 1)) -r 4 "
		  						 + "-d (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 5 -i 0.01 -g (moa.streams.generators.AssetNegotiationGenerator -i 5 -f 1)) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",		  						 
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 4 -i 0.05 -g (moa.streams.generators.HyperplaneGenerator -i 4 -a 10 -c 2 -k 2 -t 0.0)) -r 4 "
		  						 + "-d (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 5 -i 0.01 -g (moa.streams.generators.HyperplaneGenerator -i 5 -a 10 -c 2 -k 2 -t 0.0)) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",		  						 
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 4 -i 0.05 -g (moa.streams.generators.RandomRBFGenerator -i 4 -a 10 -c 2 -r 1)) -r 4 "
		  						 + "-d (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 5 -i 0.01 -g (moa.streams.generators.RandomRBFGenerator -i 5 -a 10 -c 2 -r 1)) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",		
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 4 -i 0.05 -g (moa.streams.generators.RandomTreeGenerator -i 4 -o 5 -u 5 -c 2 -r 1)) -r 4 "
		  						 + "-d (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 5 -i 0.01 -g (moa.streams.generators.RandomTreeGenerator -i 5 -o 5 -u 5 -c 2 -r 1)) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",		  		
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 4 -i 0.05 -g (moa.streams.generators.TextGenerator -i 4 -a 100)) -r 4 "
		  						 + "-d (moa.streams.generators.imbalanced.BinaryImbalancedGenerator -s 5 -i 0.01 -g (moa.streams.generators.TextGenerator -i 5 -a 100)) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",	
		  ...
		  + "-d (ConceptDriftStream -s (moa.streams.generators.ImbalancedGenerator -r 1 -i 4 -a 5 -n 1 -m 0.05 -s 1 -b 0 -p 0 -o 0 -u) -r 4 "
		  						 + "-d (moa.streams.generators.ImbalancedGenerator -r 1 -i 5 -a 5 -n 1 -m 0.01 -s 1 -b 0 -p 0 -o 0 -u) -r 5 "
		  						 + "-p 40000 -w 1) "
								 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1) "
		  						 + "-p 40000 -w 1",
		...
		String resultsPath = "D:/DataStreams-Imbalanced/binary/increasing_IR/";
